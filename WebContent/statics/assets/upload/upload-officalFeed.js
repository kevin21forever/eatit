...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        // 需要的参数
        formData:{"dinerId": $("#dinerId").val()},

        // swf文件路径
        swf: './Uploader.swf',

        // 文件接收服务端。
        server: '../upload/image_officalFeed',
    ...
    uploader.on('uploadSuccess', function( file, response ) {
        ...
        $( '#'+file.id ).append($div);
       var $li = $( '#'+file.id );
       var $wrap = $li.find( 'figure' );
       $wrap.find('img').attr('src', response.url);
       $wrap.find('a').attr('href', response.url);
